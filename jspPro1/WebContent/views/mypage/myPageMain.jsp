	...
	<section class="container-fluid">
		...
		<%@ include file="../common/mypageAside.jsp" %>
			...
			<div class="mainSection col-sm-7 ">
				...
				<div class="myGiftree col-sm-12"><h3>My Giftree</h3></div>
				
				<div class="row cardSection">
				<div class="card col-sm-6 maypageCard ">
					<div class="card-body">
					<h5 class="card-title">후원한 나무</h5>
					<div class="tree card-text"><%=count%> 그루</div>
					
					<button type="button" class="treeBtn" data-toggle="modal" data-target="#exampleModalScrollable">후원한 숲 리스트
					</button>
  ...
  <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalScrollableTitle">후원한 숲 리스트</h5>
