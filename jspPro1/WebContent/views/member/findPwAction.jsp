...
<input type = "password" style="width: 300px;font-size: 15px;" class = "userform"	id = "user_pw" name = "user_pw" maxlength="10" placeholder="새 비밀번호"> <br><br>
<input type = "password" style="width: 300px;font-size: 15px;" class = "userform"	id = "user_pwCheck" name = "user_pwCheck" maxlength="10" placeholder="새 비밀번호 확인"><br>
<div id = "pwCheck" style = "font-weight: 700;"></div> <br>
